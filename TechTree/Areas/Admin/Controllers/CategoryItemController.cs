...
namespace TechTree.Areas.Admin.Controllers
{
    ...
    public class CategoryItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,CategoryId,MediaTypeId,Description,DateTimeItemReleased")] CategoryItem categoryItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,CategoryId,MediaTypeId,Description,DateTimeItemReleased")] CategoryItem categoryItem)
        {
        ...
        {
            ViewBag.MediaType = _context.MediaType.Select(m=> m);
        }
    }
}
